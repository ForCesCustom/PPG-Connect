Connect — BepInEx edition v0.1.26
===============================
...
2. Download the complete package from
   `https://github.com/ForCesCustom/PPG-Connect/raw/main/Releases/Connect-v0.1.26.zip`.
   Extract the entire **Connect-v0.1.26.zip** directly into the folder that
...
runtime actually started and shows an explicit recovery notice if it did not.
...
The BepInEx plugin has the same runtime health check. **OPEN CONNECT** and
**COPY LINK** use the maintained direct package URL from the public Connect
repository. Use `FRIEND_INSTALL_GUIDE_RU.txt` for a Russian installation guide.
...
4. Once a friend is connected, press START SESSION.
