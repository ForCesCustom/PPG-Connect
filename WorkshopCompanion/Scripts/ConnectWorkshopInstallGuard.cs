...
namespace ConnectWorkshopCompanion
{
    ...
    public sealed class ConnectWorkshopInstallGuard : MonoBehaviour
    {
        ...
        private const string PublishedReleaseUrl = "https://github.com/ForCesCustom/PPG-Connect/raw/main/Releases/Connect-v0.1.45.zip";
        ...
        private const string ExpectedRuntimeMarkerName = "Connect.RuntimeVersion.0.1.45";
